...
var TourineLayoutComponent = /** @class */ (function () {
    function TourineLayoutComponent(stateService, menuService, themeService, bpService, sidebarService) {
        var _this = this;
    ...
    TourineLayoutComponent.prototype.ngOnDestroy = function () {
        this.layoutState$.unsubscribe();
        this.sidebarState$.unsubscribe();
        this.menuClick$.unsubscribe();
    };
    TourineLayoutComponent = __decorate([
        core_1.Component({
    ...
    return TourineLayoutComponent;
}());
exports.TourineLayoutComponent = TourineLayoutComponent;
